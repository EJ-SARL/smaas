	...
	<div class="col-md-12">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-heading">
				...
				<h2 style="text-align: center;">Modifier arret </h2>

			</div>
					
			<div class="panel-body">
			
				<form method="POST" action="index.php?demande=modifier_arret" id="theForm"  role="form" class="form-horizontal form-groups-bordered">
