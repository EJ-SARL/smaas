			...
			<div class="panel-body">
				...
				<form method="POST" action="index.php?demande=ajouter_arret"  id="theForm"  role="form" class="form-horizontal form-groups-bordered">
					...
					<div class="form-group">		
						<label class="col-sm-3 control-label">Itineraire_Id</label>
							<div class="col-sm-5">
								<div class="input-group">
									<span class="input-group-addon"><i class="entypo-user"></i></span>
									<select name="itineraire" id="itineraire"  class="form-control">
										<option value="">--Selectionner un itineraire--</option>
										<?php
											for($i=0; $i < count($itineraire); $i++)
												{         
													echo"  
															<option value=" . $itineraire[$i]->id ."> " . $itineraire[$i]->ligne ."    " . $itineraire[$i]->itineraire."</option>                       
